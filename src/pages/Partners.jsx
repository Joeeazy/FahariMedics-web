        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-blue-600/10 flex items-center justify-center text-blue-600">
  {benefit.icon}
</div>
        ...
        >
          ...
          <Link
  to="/partner-form"
  className="bg-blue-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-blue-600/90 transition-colors inline-block"
>
  Become a Partner
</Link>
